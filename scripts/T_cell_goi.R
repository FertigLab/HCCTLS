...
#these mostly came from oliviera CD4 paper
...
goi.trm = c(#HOBIT and BLIMP1 are universal regulators of tissue residency in lymphocytes (Mackay et al, Science 2016)
            ...
            "ITGAL", "ITGAM", "ITGAX")
goi.migration=c("S1PR1", "S1PR2", "S1PR4", # see Xiong et al. "CD4 T cell sphingosine 1-phosphate receptor (S1PR)1 and S1PR4 and endothelial S1PR2 regulate afferent lymphatic migration" Science Immunology 2019 (https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6744614/)
...
goi.exhaustionmarkers1 = c("PDCD1","CTLA4","LAG3", "TIGIT","HAVCR2", 
                           #  "VTCN1", #was in oliveira 2022 cd4 t cell paper, unable to confirm
...
goi.activationmarkers=c("CD38", 
                        "ENTPD1", #CD39, reported to be high in exhausted T cells https://aacrjournals.org/cancerres/article/78/1/115/625147/CD39-Expression-Defines-Cell-Exhaustion-in-Tumor 
                        "NT5E", "CD69", "IL2RA", 
                        "CD2", #co-stimulatory
...
goi.TLS.set1=c("CXCL13",
               "CXCR5", #defining marker of TfH binds to CXCL13, found on B cells and TfH
               # "CCL21", "CCL19", #removed because not in the dataset
               "CCR7", 
               "LAMP3", 
               "CXCR4",
               "LTA", 
               "LTB",
               "TNFSF14", #LIGHT
               "MADCAM1" #integrin, as expected not highly expressed
)
goi.TLS.set2=c("MS4A1", #CD20
               "CD19", 
               "SDC1", #CD138
               "TNFSF13B", #BAFF
               "TNFRSF13C", #BAFF-R
...
goi.allTLS = c(goi.TLS.set1, goi.TLS.set2)

goi.all = c(goi.allbutTLS, goi.allTLS)
